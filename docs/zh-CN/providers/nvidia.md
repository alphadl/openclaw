...
NVIDIA 在 `https://integrate.api.nvidia.com/v1` 提供 OpenAI 兼容的 API，支持 Nemotron 和 NeMo 模型。使用来自 [NVIDIA NGC](https://catalog.ngc.nvidia.com/) 的 API key 进行认证。

## CLI 设置

导出密钥后运行引导并设置 NVIDIA 模型：
